...
<meta property="description" content="Cerita">
<meta property="og:url" content="{{route('Cerita')}}">
<meta property="og:title" content="Cerita | Floating Herritage Festival">
@endsection
@section('content')
<div class="container">
    <div class="page-banner" style="background-image: url({{asset('frontsite/assets/img/bg_pattern.svg')}});" >
      <div class="row justify-content-center align-items-center h-100">
        <div class="col-md-6">
          <h1 class="text-center">Cerita</h1>
        </div>
      </div>
    </div>
</div>
