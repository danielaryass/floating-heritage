...
<meta name="description" content="Hiburan">
<meta property="og:description" content="Hiburan">
<meta property="description" content="Hiburan">
<meta property="og:url" content="{{route('Hiburan')}}">
<meta property="og:title" content="Hiburan | Floating Herritage Festival">
@endsection
@section('content')
<div class="container">
    <div class="page-banner" style="background-image: url({{asset('frontsite/assets/img/bg_pattern.svg')}});" >
      <div class="row justify-content-center align-items-center h-100">
        <div class="col-md-6">
          <h1 class="text-center">Hiburan</h1>
        </div>
      </div>
    </div>
</div>
