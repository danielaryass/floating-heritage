...
<meta name="description" content="Lingkungan">
<meta property="og:description" content="Lingkungan">
<meta property="description" content="Lingkungan">
<meta property="og:url" content="{{route('Lingkungan')}}">
<meta property="og:title" content="Lingkungan | Floating Herritage Festival">
@endsection
@section('content')
<div class="container">
    <div class="page-banner" style="background-image: url({{asset('frontsite/assets/img/bg_pattern.svg')}});" >
      <div class="row justify-content-center align-items-center h-100">
        <div class="col-md-6">
          <h1 class="text-center">Lingkungan</h1>
        </div>
      </div>
    </div>
</div>
